...
public class PosController implements Initializable, ProductInterface {
    ...
    @FXML
    private TableColumn<Item, Long> codigoColumn;
    @FXML
    private TableColumn<Item, String> itemColumn;
    @FXML
    private TableColumn<Item, Double> quantityColumn, totalColumn, unitPrice;
    @FXML
    ...
    private long codigoBarra;// Se obtiene codigo de barra del producto **
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        codigoColumn.setCellValueFactory(new PropertyValueFactory<>("codigo_barra"));
    ...
    private void showDetails(Product product) {
        if (product != null) {
            ...
            codigoBarra = product.getCodigo_barra();
    ...
    public void addAction(ActionEvent event) {
        ...
        if (validateInput()) {
            ...
            double unitPric = Double.parseDouble(priceField.getText());
            double quantity = Double.parseDouble(quantityField.getText());
            double total = unitPric * quantity;
            System.out.println("llevo este codigo de barra :: "+ codigoBarra);
            ITEMLIST.add(new Item(productName, unitPric, quantity, total,codigoBarra));
            calculation();
    ...
    private void calculation() {
        ...
        if (subTotalPrice > 0) {
            ...
            double vat = (double) subTotalPrice * 0.16; // iva al 16 %
