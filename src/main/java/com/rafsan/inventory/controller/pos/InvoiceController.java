...
public class InvoiceController implements Initializable {
    ...
    public void confirmAction(ActionEvent event) throws Exception {
        ...
        if (validateInput()) {
            ...
            System.out.println("esto es cambio 1: "+ retail);
            String cambio = String.valueOf(String.format("%.2f",retail)); // convertir double a String
            retail = Double.parseDouble(cambio);
            System.out.println("esto es cambio final: "+ retail);
