...
public class ProductController implements Initializable, ProductInterface {
    ...
    @FXML
    private TableColumn<Product, Long> idColumn,codColumn;
    @FXML
    private TableColumn<Product, String> categoryColumn,nameColumn, supplierColumn, descriptionColumn;
    @FXML
    private TableColumn<Product, Double> priceColumn, quantityColumn,costoColumn;
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        codColumn.setCellValueFactory(new PropertyValueFactory<>("codigo_barra"));
        costoColumn.setCellValueFactory(new PropertyValueFactory<>("costo_adqui"));
