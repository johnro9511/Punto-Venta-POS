...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-01-2021 a las 05:48:13
...
(1, 1, 1, 'Clinical Solutions', 165, 47, 'Anti-dandruff shampoo', 4525, 35.42),
(2, 1, 1, 'Classic Clean', 120, 144, 'General shampoo', 24434, 67.84),
(3, 4, 2, 'HiColor', 190, 33, 'Red Color 50g box', 87675, 24.5),
(4, 2, 2, 'Wax', 65, 38, 'Hair wax', 5434, 40.16),
(5, 3, 3, 'Power Light', 70, 93, 'Freshness Cream', 65543, 55.55),
(6, 3, 3, 'Oil Clear', 160, 294, 'Face Wash', 32435, 33.44),
(7, 3, 6, 'Brylcreem (Red)', 300, 128, 'Light glossy hold', 21245, 60.66),
(8, 3, 1, 'Brylcreem (Green)', 105, 0, 'Anti-dandruff', 75437, 77.77);
